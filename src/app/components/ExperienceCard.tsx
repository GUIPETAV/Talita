...
export function ExperienceCard({ title, description, icon: Icon, number }: ExperienceCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Frente do Card */}
        <div
          className="absolute w-full h-full bg-card rounded-3xl p-6 shadow-md border border-primary/20 overflow-hidden"
